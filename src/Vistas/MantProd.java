...
public class MantProd extends javax.swing.JFrame {
    ...
    private void CargarTipos(){
        try{
            ...
            for(int i=0; i <= lstTP.size(); i++){
                ...
                jComboBox1.addItem(lstTP.get(i));
            }
        }
        catch(Exception e){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            p.setCantidad(Integer.parseInt(jTextField4.getText()));
            //Polimorfismo a IVA
            Tipo_Producto TP = (Tipo_Producto) jComboBox1.getSelectedItem();

            int Porcentaje = Integer.parseInt(jTextField2.getText()) * (100 + TP.getIVA()) / 100 ;

            p.setPrecioNeto(Porcentaje );
    ...
    private javax.swing.JComboBox<Tipo_Producto> jComboBox1;
